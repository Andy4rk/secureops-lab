...
> Note: Only one Kali screenshot is provided because the Kali VMs are identical by design.
...
The initial scans are intentionally insecure — this demonstrates the real-world reality of un-hardened operating systems and creates an opportunity for before-and-after improvement.
